...
It's the process of using another process to generate CSS(style) for a website by making use of the syntax of that program then compiling back into CSS
